...
import { documentLinks } from "../../data/ShippingReturnsIds";
    ...
    <>
      <aside className={styles.documentLinks}>
        ...
        {documentLinks.map((links) => (
          ...
          >
            {links.label}
            <img className={styles.arrowImage} src={arrow} alt="arrowRight" />
          </a>
        ))}
      </aside>
      <div className={styles.main}>
        ...
        <p className={styles.text}>
          ...
          preparation and packaging to delivery, we take every step to help
          ensure your order arrives safely and ready for your space.
        </p>
        <br />
        <hr />
        <br />
        <section
          ref={(element) => {
            sectionsRef.current.Shipping = element;
          }}
          id="Shipping"
        >
          ...
          <p className={styles.text}>
            Orders are carefully prepared before leaving our facility.
            Processing times may vary depending on the product, availability,
            and whether the piece is made to order.
          </p>
          <br />
          <p className={styles.text}>
            Once your order has been processed, you will receive confirmation
            with the relevant delivery information.
          </p>
          <br />
        ...
        <section
          ref={(element) => {
            sectionsRef.current.FurnitureDelivery = element;
          }}
          id="FurnitureDelivery"
        >
          ...
          <br />
          <p className={styles.text}>
            For larger pieces, delivery may include:
          </p>
          <br />
          <ul className={styles.unorderedList}>
        ...
        <section
          ref={(element) => {
            sectionsRef.current.OrderInspection = element;
          }}
          id="OrderInspection"
        >
        ...
        <section
          ref={(element) => {
            sectionsRef.current.Returns = element;
          }}
          id="Returns"
        >
          ...
          <p className={styles.text}>
            We want you to be confident in your purchase. If your furniture
            isn't right for your space, you may be eligible to request a return
        ...
        <section
          ref={(element) => {
            sectionsRef.current.NonReturnable = element;
          }}
          id="NonReturnable"
        >
          ...
          <br />
          <p className={styles.text}>
            Please check the product page or contact our team before purchasing
            if you're unsure about an item's return eligibility.
          </p>
        </section>
        <br />
        <hr />
        ...
        <section
          ref={(element) => {
            sectionsRef.current.Exchange = element;
          }}
          id="Exchange"
        >
        ...
        <section
          ref={(element) => {
            sectionsRef.current.Refunds = element;
          }}
          id="Refunds"
        >
          ...
          <br />
          <p className={styles.text}>
            Depending on your payment provider, it may take several business
        ...
        <section
          ref={(element) => {
            sectionsRef.current.ChangesCancellations = element;
          }}
          id="ChangesCancellations"
        >
